...
public class Google_Search_With_Reusable_Annotations extends Reuseable_Annotations_Class {
    ...
    public void GoogleSearchForKeyword(){
        ...
        Reuseable_Actions_Loggers.sendKeysAction(driver,"//*[@name='q']","BMW",logger,"Search Field");
        //submit the go button
        Reuseable_Actions_Loggers.submitAction(driver,"//*[@name='btnK']",logger,"Google Search Button");
    }//end of test 1
    ...
    public void GoogleCaptureSearchNumber(){
        ...
        String result = Reuseable_Actions_Loggers.getTextAction(driver,"//*[@id='result-stats']",logger,"Search Result Text");
